        ...
        >
          ...
          <div className="px-6 py-4 overflow-y-auto max-h-[50vh]">
                ...
                {FORMAT_OPTIONS.map((option) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-1.5 px-3 py-1.5 text-sm rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 ${isSelected
            ...
            <div className="flex gap-2 mb-3" role="tablist" aria-label="View mode">
              <button
                ...
                className={`px-3 py-1.5 text-sm rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 ${showPreview
                  ...
                  <div className="pt-2 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <ul className="space-y-1">
                      {todo.subtasks?.map((subtask) => (
                        <li
                          key={subtask.id}
                          className={`text-sm flex items-center gap-2 ${subtask.completed
          ...
          <div className="px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex gap-3">
            ...
            <button
              ...
              className={`flex-1 px-4 py-2.5 text-sm font-medium rounded-xl flex items-center justify-center gap-2 transition-all focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 ${getCopyButtonStyles()} ${copyState === 'success' ? 'cursor-default' : ''
                }`}
            >
