      ...
      <div className="grid gap-6 grid-cols-1 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card>
            ...
            {/* AI Focus Suggestion */}
            {aiData.todaysFocus && (
              <div className={`flex items-start gap-3 p-3 rounded-[var(--radius-xl)] mb-4 ${
                'bg-blue-50 border border-blue-200'}`}>
                <Brain className={`w-4 h-4 mt-0.5 flex-shrink-0 ${'text-[#0033A0]'}`} />
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <div className="space-y-4">
              ...
              <p className={`text-xs text-center font-medium tabular-nums ${'text-slate-400'}`}>
          ...
          <Card>
            <div className="grid grid-cols-2 gap-4">
              <div className={`text-center p-4 rounded-[var(--radius-xl)] transition-colors ${'bg-slate-50'}`}>
              ...
              <div className={`text-center p-4 rounded-[var(--radius-xl)] transition-colors ${
                stats.highPriority > 0
                  ? 'bg-orange-50 border border-orange-200/50': 'bg-slate-50'}`}>
