...
function SkeletonTaskItem() {
  return (
    <div className="flex items-center gap-3 px-3 py-2.5 rounded-[var(--radius-lg)] bg-[var(--surface-3)]/30">
...
export default function DailyDigestSkeleton() {
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-[var(--radius-xl)] p-4 bg-red-500/5 border border-red-500/20">
      ...
      <div className="rounded-[var(--radius-xl)] p-4 bg-[var(--surface-2)] border border-[var(--border)]">
        <div className="flex items-center gap-2 mb-3">
      ...
      <div className="rounded-[var(--radius-xl)] p-4 bg-gradient-to-br from-[var(--brand-blue)]/5 to-[#C9A227]/5 border border-[var(--brand-blue)]/20">
        <div className="flex items-center gap-2 mb-3">
