...
export default function AppMenu({
  ...
  const dividerClass = `border-t ${'border-[var(--border)]'} my-1`;
    ...
    <div className="relative" ref={menuRef}>
      ...
      <button
        ...
        className={`p-2 rounded-[var(--radius-xl)] transition-all duration-200 ${
          'text-[var(--text-muted)] hover:text-[var(--brand-blue)] hover:bg-[var(--surface-2)]'} ${isOpen ? ('bg-[var(--surface-2)] text-[var(--brand-blue)]') : ''}`}
        aria-label="Menu"
          ...
          >
            ...
            <div className="py-1">
              ...
              >
                ...
                <span className={`text-xs ml-auto ${'text-[var(--text-muted)]'}`}>?</span>
              </button>
            </div>
