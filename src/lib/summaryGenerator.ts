...
export function generateTaskSummary(
  ...
  lines.push('');
  lines.push('═══════════════════════════════════════');
  lines.push('Generated by Wavezly Todo App');
...
export function generateMarkdownSummary(
  ...
  lines.push('');
  lines.push('---');
  lines.push(`*Generated by Wavezly Todo App on ${format(now, "MMMM d, yyyy 'at' h:mm a")}*`);
...
export function generateJSONSummary(
  ...
  summary.generator = 'Wavezly Todo App';
