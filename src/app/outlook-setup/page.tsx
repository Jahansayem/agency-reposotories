            ...
            >
              {downloading ? (
                ...
                <>
                  ...
                  Download for Web / New Outlook
                </>
              )}
            </button>
            <button
              onClick={downloadDesktopManifest}
              disabled={downloadingDesktop}
              className="flex-1 px-4 py-3 bg-slate-700 text-white rounded-xl font-medium hover:bg-slate-800 transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
            >
              {downloadingDesktop ? (
                <>
                  <svg className="w-5 h-5 animate-spin" fill="none" viewBox="0 0 24 24">
                ...
                <>
                  ...
                  Download for Classic Desktop
                </>
              )}
            </button>
          </div>
          <p className="text-xs text-slate-500 mt-2 text-center">
            Use &quot;Web / New Outlook&quot; for Outlook on the web or the new Outlook app. Use &quot;Classic Desktop&quot; for traditional Outlook on Windows/Mac.
          </p>
