    ...
    it('should filter todos with attachments', () => {
      const todos = [
        createMockTodo({
          ...
          attachments: [{ id: 'a1', file_name: 'doc.pdf', file_type: 'document', file_size: 100, storage_path: 'path', mime_type: 'application/pdf', uploaded_by: 'User', uploaded_at: new Date().toISOString() }],
        }),
